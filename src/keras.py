...
with open('../../ClearImages/words_coordinates.json') as json_file:
...
def build_model():
    ...
    new_shape = ((img_width // downsample_factor), (img_height // downsample_factor) * conv_filters)
    x = layers.Reshape(target_shape=new_shape, name="reshape")(x)
    x = layers.Dense(time_dense_size, activation="relu", name="dense1")(x)
